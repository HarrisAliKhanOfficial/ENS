...
contract UniversalRegistrarController is Ownable, BaseUniversalRegistrarController {
    ...
    function domainPassRegister(bytes32 node, string calldata name, address owner, bytes32 secret, bytes32[] calldata merkleProof) external payable {
    ...
    function domainPassRegisterWithConfig(bytes32 node, string memory name, address owner,
        ...
        require(store.isDomainPassEligible(msg.sender), "Caller does not have domain pass!");
